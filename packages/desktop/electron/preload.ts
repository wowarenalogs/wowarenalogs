...
const api: WALWindowAPI = {
  ...
  fsExistsSync: (path: string) => ipcRenderer.invoke(eventNames.IPC_FS_EXISTS_SYNC, path),
  ...
  fsWriteFileSync: (args: { path: number | string; data: any; options?: WriteFileOptions | undefined }) =>
