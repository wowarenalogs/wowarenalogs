...
export class CombatantInfoAction {
  ...
  constructor(public readonly logLine: ILogLine) {
    ...
    this.info = {
      ...
      item9: logLine.parameters[9],
      critMelee: logLine.parameters[10],
      critRanged: logLine.parameters[11],
      critSpell: logLine.parameters[12],
      speed: logLine.parameters[13],
      lifesteal: logLine.parameters[14],
      hasteMelee: logLine.parameters[15],
      hasteRanged: logLine.parameters[16],
      hasteSpell: logLine.parameters[17],
      avoidance: logLine.parameters[18],
      mastery: logLine.parameters[19],
      versatilityDamgeDone: logLine.parameters[20],
      versatilityHealingDone: logLine.parameters[21],
      versatilityDamageTaken: logLine.parameters[22],
      armor: logLine.parameters[23],
      specId: logLine.parameters[24].toString(),
      talents: logLine.parameters[25].map((v: number[]) => ({ id1: v[0], id2: v[1], count: v[2] })),
      pvpTalents: logLine.parameters[26].map((v: number) => v.toString()),
