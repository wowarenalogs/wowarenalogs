...
// A round is a draw when an opposite-team death lands before the next Arena Preparation
// (32727) burst. A death after that burst belongs to the post-round window.
