...
import { CombatHpUpdateAction, ICombatData, ICombatUnit } from 'wow-combat-log-parser';
...
export const ReplayHpNumbers = (props: IProps) => {
  ...
  const MIN_NUMBER = combatReportContext.combat?.wowVersion === 'shadowlands' ? 3000 : 300;
